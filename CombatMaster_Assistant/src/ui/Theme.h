...
namespace Theme {
    inline void Apply() {
        ...
        // Modern Opaque 'Bloodstrike' Theme
        colors[ImGuiCol_Text]                   = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
        colors[ImGuiCol_TextDisabled]           = ImVec4(0.50f, 0.50f, 0.50f, 1.00f);
        colors[ImGuiCol_WindowBg]               = ImVec4(0.06f, 0.06f, 0.07f, 1.00f); // Fully Opaque
        colors[ImGuiCol_ChildBg]                = ImVec4(0.08f, 0.08f, 0.09f, 1.00f); // Fully Opaque
        colors[ImGuiCol_PopupBg]                = ImVec4(0.08f, 0.08f, 0.09f, 1.00f); // Fully Opaque
        colors[ImGuiCol_Border]                 = ImVec4(1.00f, 0.00f, 0.00f, 0.15f); // Subtle red border
        ...
        colors[ImGuiCol_FrameBgActive]          = ImVec4(1.00f, 0.00f, 0.00f, 0.20f);
        ...
        colors[ImGuiCol_ScrollbarGrabHovered]   = ImVec4(1.00f, 0.00f, 0.00f, 0.60f);
        ...
        colors[ImGuiCol_SeparatorHovered]       = ImVec4(1.00f, 0.00f, 0.00f, 0.60f);
        ...
        colors[ImGuiCol_TabHovered]             = ImVec4(1.00f, 0.00f, 0.00f, 0.60f);
        colors[ImGuiCol_TabActive]              = ImVec4(1.00f, 0.00f, 0.00f, 0.40f);
        ...
        colors[ImGuiCol_TableBorderStrong]      = ImVec4(0.18f, 0.18f, 0.20f, 1.00f);
        ...
        style.WindowRounding    = 0.0f; // Sharp modern look
